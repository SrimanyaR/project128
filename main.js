...
random_no = Math.floor((Math.Randon()*array_1.length)+1)

quick_draw_data_set = array_1 [random_no] 

document.getElementById("SketchToBeDrawn").innerHTML="Sketch To be Drawn" + quick_draw_data_set;
...
function gotResult(error, results) {
    ...
    console.log(results);
    document.getElementById('YourSketch').innerHTML = 'Label:' + results[0].label;
